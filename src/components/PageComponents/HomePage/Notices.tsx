...
export function Notices() {
  ...
  return (
    <section id="updates" className="py-10 bg-white relative overflow-hidden">
          ...
          {latestNotices.length === 0 ? (
            ...
            (
              latestNotices.map((update, index) => (
                ...
                >
                  <div
                    className={`bg-white rounded-xl p-6 shadow-lg border-l-4 group hover:-translate-y-1 transition-all h-full flex flex-col ${update.type === 'urgent'
                      ? 'border-[#F59E0B]'
                      : update.type === 'success'
                        ? 'border-[#10B981]'
                        : 'border-[#0F172A]'
